...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.button_input_info = QtWidgets.QPushButton('input info')  # 建立用于input info的按键
        ...
        self.__layout_fun_button.addWidget(self.button_input_info)  # 把input info的按键放到按键布局中
    ...
    def slot_init(self):
        ...
        self.button_input_info.clicked.connect(
            self.button_input_info_clicked)  # 若该按键被点击，则调用button_input_info_clicked()
    ...
    def button_open_camera_clicked(self):
        if not self.timer_camera.isActive():  # 若定时器未启动
            ...
            if not flag:  # flag表示open()成不成功
                ...
                self.timer_camera.start(25)  # 定时器开始计时30ms，结果是每过30ms从摄像头中取一帧显示
            ...
            # face_recognition.recognize_face_name_mask()/
    ...
    def button_input_info_clicked(self):
